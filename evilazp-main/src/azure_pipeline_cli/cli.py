...
def build_parser() -> argparse.ArgumentParser:
    ...
    shell_parser.add_argument("--poll-interval", type=float, default=1, help="build poll interval in seconds")
...
def add_common_azure_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--poll-interval", type=float, default=1, help="build poll interval in seconds")
