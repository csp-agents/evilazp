...
namespace Microsoft.VisualStudio.Services.Agent.Worker
{
    ...
    public sealed class ExecutionContext : AgentService, IExecutionContext, ICorrelationContext, IDisposable
    {
        ...
        private static bool FileLogStreamingDisabled => true;
        ...
        public override void Initialize(IHostContext hostContext)
        {
            ...
            if (!FileLogStreamingDisabled && agentSettings.ReStreamLogsToFiles)
            {
                _logsStreamingOptions |= LogsStreamingOptions.StreamToFiles;
            }
            else if (!FileLogStreamingDisabled && agentSettings.DisableLogUploads)
            {
                _logsStreamingOptions = LogsStreamingOptions.StreamToFiles;
            }
